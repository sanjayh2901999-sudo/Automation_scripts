package Com.Crm.Comcast.ContactTest_GroupExecution_Testng;
...
import Com.Crm.Generic.BaseUtility_GroupExecution_TestNg.Base_Class_TestNg2;
import Com.Crm.Generic.BaseUtility_TestNg.Base_Class_TestNg;

public class Create_Contact_Test_TestNg extends Base_Class_TestNg2 
{
...
// read test script data from excel file
		...
		String act_last_name = driver.findElement(By.xpath("//input[@name='lastname']")).getAttribute("value");

		if (act_last_name.contains(lastName)) 
		{
...
Contact_Page cp = new Contact_Page(driver);
	...
	public void createContactWithOrgTest() throws Exception 
	{
		// read test script data from excel file
				...
				if (actOrgName1.contains(org_Name))
				{
