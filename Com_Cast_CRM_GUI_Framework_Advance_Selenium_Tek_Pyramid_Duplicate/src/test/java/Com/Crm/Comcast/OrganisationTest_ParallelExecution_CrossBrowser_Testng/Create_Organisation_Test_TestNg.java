package Com.Crm.Comcast.OrganisationTest_ParallelExecution_CrossBrowser_Testng;
...
public class Create_Organisation_Test_TestNg extends Base_Class_TestNg3
{
...
Home_Page_Object_Repository hp = new Home_Page_Object_Repository(getDriver());
	...
	Organisation_Page_Object_Repository op = new Organisation_Page_Object_Repository(getDriver());
	...
	Organization_Info_Page oip= new Organization_Info_Page(getDriver());
...
// read testscript data from excel 
	...
	Creating_New_Organization_Page cop = new Creating_New_Organization_Page(getDriver());
	...
	String actPhoneNumber = getDriver().findElement(By.id("mouseArea_Phone")).getText().trim();
...
public void createOrgWithIndustriesTest() throws Exception
{
	...
	// step3: click on create organisation button
	Organisation_Page_Object_Repository cnop= new Organisation_Page_Object_Repository(getDriver());
	...
	String actIndustries = getDriver().findElement(By.xpath("//td[@id='mouseArea_Industry']")).getText();
