package Com.Crm.Comcast.ContactTest_ParallelExecution_CrossBrowser_Testng;
...
import Com.Crm.Generic.BaseUtility_Parallel_CrossBrowser_TestNg.Base_Class_TestNg3;


public class Create_Contact_Test_TestNg extends Base_Class_TestNg3 
{
	@Test
...
// read test script data from excel file
		...
		Contact_Page cp = new Contact_Page(getDriver());
		cp.getCreateContact().click();

		// Step4: Enter all the details and create new Contact
		Creating_New_Contact_Page2 ccp = new Creating_New_Contact_Page2(getDriver());
		ccp.creatingNewContact(lastName);
		// verify Header phone Number info Expected Result
		String act_Header = getDriver().findElement(By.className("dvHeaderText")).getText();
		...
		String act_lastName=getDriver().findElement(By.id("dtlview_Last Name")).getText();
...
Contact_Page cp = new Contact_Page(getDriver());
		...
		// verify header phone number info expected result 
		String actStartDate= getDriver().findElement(By.id("dtlview_Support Start Date")).getText();
		...
		String actEndDate = getDriver().findElement(By.id("dtlview_Support End Date")).getText();
...
// read test script data from excel file
		...
		Organisation_Page_Object_Repository cnp = new Organisation_Page_Object_Repository(getDriver());
		cnp.getCreateNewOrgBtn().click();
		// Step4: Enter all the details and create new organization
		Creating_New_Organization_Page cnop = new Creating_New_Organization_Page(getDriver());
		...
		// verify Header OrgName info Expected Result
		Contact_Information_Page cip = new Contact_Information_Page(getDriver());
