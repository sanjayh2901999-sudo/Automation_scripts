package Com.Crm.Generic.BaseUtility_TestNg_Debugging_Concept;
...
/*
 * note in order to insert the break point in the script press control+Shift+B
 * 
 * 
 */
public class Base_Class_Debbugging_TestNg 
{
